    ...
    public static void main(String args[]) {
        ...
        do {
            ...
            switch (opt) {
                ...
                case 5: {
                    System.out.println("Introduce la matrícula");
                    String mat = sca.nextLine();
                    if(concesionario.eliminarVehiculo(mat)){
                        System.out.println("Vehiculo eliminado");
                    }
                    else{
                        System.out.println("No se ha podido realizar la operación de borrado");
                    }
                    break;
                }
                case 6: {
